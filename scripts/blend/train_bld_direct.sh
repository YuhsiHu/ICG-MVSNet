...
python -m torch.distributed.launch --master_port 12345 --nproc_per_node=1 train_bld.py --logdir $BLD_LOG_DIR --dataset=blendedmvs --batch_size=2 --trainpath=$BLENDEDMVS_ROOT --summary_freq 100 --lr=0.002 --epochs=15 \
