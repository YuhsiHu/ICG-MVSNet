...
class MVSDataset(Dataset):
    def __init__(self, datapath, listfile, split='intermediate', nviews=7):
        self.levels = 4
        self.datapath = datapath
        self.split = split
        self.scans = listfile
        self.n_views = nviews
        assert self.split in ['intermediate', 'advanced'], \
            'split must be either "intermediate" or "advanced"!'
        self.build_metas()
