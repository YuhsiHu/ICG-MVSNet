...
class MVSDataset(Dataset):
    def __init__(self, datapath, listfile, split, nviews, interval_scale=1.06, **kwargs):
    ...
    def build_list(self):
        ...
        print("dataset", self.split, "metas:", len(metas), "interval_scale:{}".format(self.interval_scale))
        return metas
