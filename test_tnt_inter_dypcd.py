...
e = 11
conf_all = {'Family':0.35, 'Francis':0.4, 'Horse':0.2, 'Lighthouse':0.75, 'M60':0.4, 'Panther':0.3, 'Playground':0.4, 'Train':0.4}
...
# e = 11
# conf_all = {'Family':0.35, 'Francis':0.4, 'Horse':0.2, 'Lighthouse':0.75, 'M60':0.4, 'Panther':0.3, 'Playground':0.4, 'Train':0.4}
# dist_all = {'Family':1/4, 'Francis':1/4, 'Horse':1/4, 'Lighthouse':1/4, 'M60':1/4, 'Panther':1/4, 'Playground':1/4, 'Train':1/4}
# rel_diff_all = {'Family':1/1500, 'Francis':1/1500, 'Horse':1/1000, 'Lighthouse':1/1000, 'M60':1/1600, 'Panther':1/1500, 'Playground':1/1600, 'Train':1/1600}
########################################## 
...
parser.add_argument('--nviews', type=int, default=11, help='num of view')
...
def save_scene_depth(testlist):
    ...
    test_dataset = MVSDataset(os.path.dirname(args.testpath.rstrip('/')), listfile=testlist, split=os.path.basename(args.testpath.rstrip('/')), nviews=args.nviews)
