...
##########################################
# dist_base=1/32
# rel_diff_base=1/4000
# conf_all = {'scan1':0.60, 'scan4':0.60, 'scan9':0.55, 'scan10':0.55, 'scan11':0.55, 'scan12':0.50, 'scan13':0.55, 'scan15':0.55, \
#             'scan23':0.55, 'scan24':0.60, 'scan29':0.55, 'scan32':0.55, 'scan33':0.55, 'scan34':0.60, 'scan48':0.50, 'scan49':0.55, \
#             'scan62':0.55, 'scan75':0.55, 'scan77':0.50, 'scan110':0.60, 'scan114':0.60, 'scan118':0.60}
########################################## 
...
parser.add_argument('--plydir', default='pcd_fusion_plys/', help='pointcloud dir')
...
def filter_depth(pair_folder, scan_folder, out_folder, plyfilename):
    ...
    for ref_view, src_views in pair_data:
        ...
        for src_view in src_views: # 10 views
...
def dypcd_filter_worker(scene):
    ...
    filter_depth(pair_folder, scan_folder, out_folder, os.path.join(args.outdir, args.plydir, save_name))
...
def save_scene_depth(testlist):
    ...
    test_dataset = MVSDataset(args.testpath, testlist, "test", args.nviews, Interval_Scale,
