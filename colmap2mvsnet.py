...
if __name__ == '__main__':
    ...
    for i in range(num_images):
        ...
        # depth_max = zs_sorted[int(len(zs) * 0.9)]
        # strict depth range, use dense.compute_depth_range to get the depth range
        depth_min = zs_sorted[int(len(zs) * 0.1)] * 0.9
        depth_max = zs_sorted[int(len(zs) * 0.7)] * 1.1
